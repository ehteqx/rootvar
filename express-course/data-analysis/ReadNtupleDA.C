...
void ReadNtupleDA() {
  //   Example to read Ntuple and make some selections, it will create some histograms
  ...
  TH2F *h1vs2 = new TH2F("h1vs2", "h1vs2",100,0.,255.,100,0.,255.);
  ntuple->Draw("adc1:adc2>>h1vs2","", "lego");
